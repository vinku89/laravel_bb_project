...
<head>
    ...
    <title>BestBOX - Recent Movie Images</title>
...
<body>
    ...
    <div class="main-content sales_transaction">
        ...
        <section class="main_body_section scroll_div">
          <h5 class="font16 black_txt font-bold text-uppercase pt-4 pb-3">Recent Movies Images</h5>
			<div class="row">
			...
			<!-- <div class="row">
				<div class="col-sm-6 order-2 order-sm-1">
					<button type="submit" class="delImage"  id="deleteToAll">Delete All</button>
				</div>
			</div> -->
          <div class="middle_box clearfix">
            <div class="grid_wrp add-user-grid">
              <div class="grid_header clearfix pt-3 pb-3 d-lg-block d-none">
                ...
                <div class="w30 float-left font16 font-bold blue_txt pl-2">Image</div>
              ...
              <div class="grid_body clearfix">
                ...
                <div class="grid_row clearfix border-top">
                    ...
                    <div class="w30 grid_td_info word-break">
                        <span class="mob_title blue_txt d-block d-lg-none">Image</span>
                        <?php echo $au['movie_image'];?>
                    </div>

...
<head>
    ...
    <title>BestBOX - Renewal Activation</title>
...
<body>
    ...
    <div class="main-content sales_transaction">
        ...
        <section class="main_body_section scroll_div">
            <h5 class="font16 black_txt font-bold text-uppercase pt-4 pb-3">Renewals Activation</h5>
            <!-- Filter section -->
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-sm-6 mt-3 mt-sm-0 pl-0">
                                <a href="<?php echo url('/updateOrderFromAdmin/2');?>" class="btn btn_primary d-block">Update Order</a>
                            </div>
                        </div>
            ...
            <div class="grid_wrp d-lg-block d-none">
                <div class="grid_header clearfix pt-3 pb-3">
                    ...
                    <div class="w26 float-left font16 font-bold blue_txt pl-2">Full Name <br> ( UserId )</div>
                        ...
                        @if($request_list->count())
                            ...
                            <div class="grid_row clearfix border-bottom">
                                ...
                                <div class="w10 float-left font16 dark-grey_txt text-right pr-3">
                                    @If($item['status'] == 1)
                                    <a href="{{ url('/subscribePackage').'/'.base64_encode($item['rec_id']).'/2' }}" class="pending_btn">Pending</a>
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-5 text-right">
                                @If($item['status'] == 1)
                                <a href="{{ url('/subscribePackage').'/'.base64_encode($item['rec_id']).'/2' }}" class="pending_btn f12">Pending</a>
                                @else
    ...
    <script type="text/javascript">
     var url = "<?php echo url('/renewalActivation'); ?>";

...
<head>
    ...
    <!-- for tracking -->
        ...
        .users_info_wrp.reminder .dashcell{
            color: #333 !important;
        }

        .users_info_wrp.reminder .dashcell p{
            color: #333 !important;
        }

        .users_info_wrp.reminder .text-white{
            color: #333 !important;
        }
        </style>
</head>
<body>
    ...
    <div class="main-wrap w-100">
            ...
            <div class="row">
                ...
                <section class="customer_main_body_section scroll_div col-12">
                    ...
                    <div class="custom--nav-bar_left d-block d-lg-none">
                        ...
                        <div class="d-inline-block addonbtn text-white mr-3 text-uppercase f10">My Referral ID
                        </div>
                        <div class="btn-group d-inline-block" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-outline-secondary text-white px-4 f10"><?php echo $loggedUserData['refferallink_text'];?></button>
                            <button type="button" class="btn btn-outline-secondary text-white px-3 f10 copyBtn" style="margin-left: -5px;" data-clipboard-text="<?php echo url("/").'/customerSignup/'.$loggedUserData['refferallink_text'];?>">
                                <i class="mr-2 d-inline-block">
                                    <img src="<?php echo url('/');?>/public/img/customer/copy.png" class="img-fluid">
                                </i>
                                Copy
                            </button>
                            <button type="button" class="btn btn-outline-secondary text-white px-3 f10" data-toggle="modal" data-target="#share_modal" style="margin-left: -5px;">
                                <i class="mr-2 d-inline-block">
                    ...
                    <div class="">
                        ...
                        <div class="div_item clearfix text-center text-md-left row <?php echo $vplayedClass?>">
                            ...
                            <div class="text-center text-md-right font12 col-xl-6 col-md-5 col-sm-12 text-white"
                            ...
                            <div class="col-lg-3 col-md-6 mb-2">
                                <div class="middle_box ">
                                    <div class="p-3 wallet-balance_bg clearfix">
                                        <div class="balance_wrap pb-4 text-center">
                                        ...
                                        <div class="text-center amount_wrp px-2 py-0">
                                            <h1 class="bigFont w-100">
                                                $<?php
                                    ...
                                    <div class="p-3 wallet-balance_bg clearfix">
                                        <div class="balance_wrap pb-4 text-center">
                                            <img src="<?php echo url('/');?>/public/customer/images/referral-earnings.png?q=<?php echo rand();?>"
                                                class="wallet-icon">
                                            <h5 class="wallet-title font16 black_txt font-bold text-uppercase">Referral
                                                Earnings
                                            </h5>
                                        </div>
                                        <div class="text-center amount_wrp px-2 py-0">
                                    ...
                                    <div class="p-3 wallet-balance_bg clearfix">
                                        <div class="balance_wrap pb-4 text-center">
                                            <img src="<?php echo url('/');?>/public/customer/images/total-referral.png?q=<?php echo rand();?>"
                                                class="wallet-icon">
                                            <h5 class="wallet-title font16 black_txt font-bold text-uppercase">Total
                                                Referral
                                            </h5>
                                        </div>
                                        <div class="text-center amount_wrp px-2 py-0">
                                    ...
                                    <div class="p-3 wallet-balance_bg clearfix">
                                        <div class="balance_wrap pb-4 text-center">
                                            <img src="<?php echo url('/');?>/public/customer/images/pay-friend.png?q=<?php echo rand();?>"
                                                class="wallet-icon">
                                            <h5 class="wallet-title font16 black_txt font-bold text-uppercase">Pay for
                                                my friend
                                            </h5>
                                        </div>
                                        <div class="text-center amount_wrp px-2 py-0">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6">
                                    <div class="div_item_wrp">
                                        <div class="item_icon">
                                            <img
                                                src="<?php echo url('/');?>/public/customer/images/trial-circle-icon.png">
                                        </div>
                                ...
                                <div class="col-xl-6 col-md-6 req_trial_btn_wrp">
                                    <a href="{{ url('/freeTrailRequest') }}" class="btn req_trial_btn">Request Free
                                        Trial</a>
                                </div>
                            </div>
                        </div>
                        @endIf
                        <?php
                        $pkgdata2 = \App\Package_purchase_list::where('user_id',$users_data['rec_id'])->where('active_package',1)->where('package_id','!=',11)->orderBy('rec_id','DESC')->first();
                        ...
                        if(!empty($freetrial_qry)){
                            ...
                            if(($statusMsg == 0 || $statusMsg == 3) && empty($pkgdata2)){
                                if($statusMsg == 0){
                        ...
                        <div class="grid3 <?php echo $vplayedClass?>">
                            ...
                            <div
                                ...
                                <div class="col-12">
                                    <div class=" row">
                                        <div class="col-lg-cell5 col-md-4 sm-border-bottom align-self-center dashcell">
                                        ...
                                        <div class="col-lg-cell5 col-md-4 sm-pb-4 sm-border-bottom align-self-center dashcell">
                                        ...
                                        <div class="col-lg-cell5 col-md-6 position_relative  xs-border-bottom align-self-center dashcell">
                                            ...
                                            <p>
                                                ...
                                                <div class="text-left text-white f12 mt-2">Expiry :
                                        ...
                                        <div class="col-lg-cell5 col-md-6 position_relative align-self-center dashcell">
                                            <p class="small_device">Renewal</p>
                                            <div class=" text-left">
                                                @if($users_data['expiry_date'] != '' || (!empty($qs) && $qs->status ==
                                                3))
                                                ...
                                                <p href="#" class="d-inline-block" style="color: #007bff">Not Subscribed
                                                </p>
                                                @elseIf(!empty($qs) && $qs->status == 1 && $pkgcnt >= 1 &&
                                                $users_data['id'] !=
                                                11)
                                                <p href="#" class="d-inline-block text_view">
                                                    Renewal<br>Approval
                                                    Pending</p>
                                    ...
                                    <div class=" row">
                                        ...
                                        <div class="col-lg-cell5 col-md-6 position_relative  xs-border-bottom">
                                            ...
                                            <p>
                                                @if($data['id'] != 11)
                                                @if(!empty($pkgdata) && $pkgdata['expiry_date'] != '')
                                                <div class="font16 inline-block {{ $pkgdata['expiry_date'] < NOW() ? 'label_expired' : 'label_active' }}">
                                                </div>
                                                <div class="text-left text-white">Expiry :
                                                    {{ date('d/m/Y',strtotime($pkgdata['expiry_date'])) }}</div>
                                                @else
                                                <div class="font16 inline-block text-white">-</div>
                                                @endIf
                                                @else
                                                {{ '-' }}
                                                @endIf
                                        ...
                                        <div class="col-lg-cell5 col-md-6 position_relative ">
                                            <p class="small_device text-white">Renewal</p>
                                            <div class=" text-left">
                                                @if($data['expiry_date'] != '')
                                                ...
                                                <p href="#" class="d-inline-block text_view">
                                                    ...
                                                    Pending</p>
                                                @elseIf(!empty($qs) && $qs->status == 1 && $pkgcnt == 0)
                                                <p href="#" class="d-inline-block text_view text-orange">
                                                    Subscription<br>Approval Pending</p>
                                                @else
                                                {{ '-' }}
                                                @endIf
                        ...
                        <br>
                        <h2 class="font35 font-bold text-white mb-3">SUBSCRIPTION PLANS</h2>
                        <!-- IPTV Box List -->
                        <!-- ===============09-04-2020 =================-->
                        <h3 class="font22 font-bold text-white mb-3 mt-4">BestBOX Package</h3>
                        <!--========================== New Packages ===================-->
                        <div class="col-12 p-0 row-flex mb-4">
                            ...
                            <div class="bb_packages_wrapper">
                                <div class="bvod_priceTag">
                                    <span class="info_link"><i class="fa fa-info-circle" aria-hidden="true"
                                            data-toggle="modal" data-target="#imp-note"></i></span>
                        ...
                        <div class="col-12 p-0 row-flex mb-4">
                            ...
                            <div class="bb_packages_wrapper active_box">
                                ...
                                <div class="bbox_inner_content_box">
                                    ...
                                    @if($iptv_box['duration'] !=0 && $iptv_box['duration'] != 1)
                                    <!-- <div class="ribbon-v1">
                                        <span class="ribbon1">
                                            <span>
                                                <img src="<?php //echo url('/');?>/public/images/free_spotify.png" class="img-fluid">
                                            </span>
                                        </span>
                                    </div> -->
                                    @endIf
                                    <!-- <div class="ribbon">
                                        <span><img src="<?php echo url('/');?>/public/images/free_spotify.png"
                        ...
                        <h3 class="font22 font-bold text-white mb-3">IPTV Box</h3>
                        <div class="col-12 p-0 row-flex ">
                            ...
                            <div class="new_iptvbox_wrp">
                                ...
                                <div class="inner_content_box">
                                    ...
                                    @endIf
                                    <img src="<?php echo url('/').'/public/customer/images/iptvBox.png';?>"
                                        alt="BestBOX">
                                    <p>
        ...
        <!-- <footer class="py-2" style="background-color: #303030;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <p class="m-0 f12 text-white">
                            This site is fully compatible with Chrome browser
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade imp-note" tabindex="-1" id="pkgSubscriptionBeforeSevenDays">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header" style="padding:5px; background-color: #ef0e23;">
                ...
                <div class="modal-footer p-0">
                    ...
                    <div class="row w-100 m-auto p-3">
                        <div class="col-6">
                            <a class="btn btn-secondary w-100" data-dismiss="modal">Renew Later</a>
                        </div>
                        <div class="col-6">
                            <a href="{{ url('/').'/renewal/'.encrypt($users_data['rec_id']) }}" class="btn-success btn w-100">Renew</a>
                        </div>
                    </div>
                </div>
            </div>

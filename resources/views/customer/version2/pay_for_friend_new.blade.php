                            ...
                            <div id="step1">
                                <form method="post" id="create_form" name="create_form"
                                    ...
                                    <div class="form_bg5">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-12 mt-3 pl-0">
                                                <div class="form-group form-check">
                                                    <input type="checkbox" name="pay" id="exampleCheck1" data-value='wallet'
                                                        ...
                                                        style="width: inherit;">
                                                    <label class="form-check-label payfor_friend text-white" style="color: #fff !important;top:0px !important; "
                                            ...
                                            <div class="col-12 mt-4 pl-0" >
                                                <div class="form-group form-check">
                                                    <input type="checkbox" name="pay" id="exampleCheck3" data-value='bankpayment' value="BANKPAYMENT" class="payment form-check-input" style=" width: inherit;">
                                                    <label class="form-check-label payfor_friend" for="exampleCheck3" style="color:#fff !important;top:0px !important;">Nigeria or Ghana based bank payments
                                                    <!--<span class="pl-3"><img src="{{ url('/') }}/public/customer/images/bit-pay-logo.png?q=<?php //echo rand();?>" style="width:75px;"></span>-->
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-12 mt-4 pl-0" >
                                                <div class="form-group form-check">
                                                    <input type="checkbox" name="pay" id="exampleCheck2" data-value='bitpay' value="Crypto Currency" class="payment form-check-input" style=" width: inherit;">
                                                    <label class="form-check-label payfor_friend" for="exampleCheck2" style="color:#fff !important;top:0px !important;">Crypto Currency Payment
                                                    <!--<span class="pl-3"><img src="{{ url('/') }}/public/customer/images/bit-pay-logo.png?q=<?php //echo rand();?>" style="width:75px;"></span>-->
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div id="shipping_addr" style="display: none;">
                                        <div class="text-center my-2 f14 font-bold " style="color:#fff !important;">Shipping Address
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="">
                                            ...
                                            <div class="col-12 mt-4 pl-0">
                                                <div class="form-group form-check">
                                                    <label class="form-check-label payfor_friend" style="color: #fff !important;"
                                                        for="exampleCheck1">Nigeria or Ghana based bank payment
                                                        <!-- <span
                                                    class="pl-3"><img src="{{ url('/') }}/public/customer/images/bit-pay-logo.png?q=<?php //echo rand();?>" style="width:100px;"></span> -->
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-none" id="bitpay_pay">
                                            <div class="col-12 mt-4 pl-0">
                                                <div class="form-group form-check">
                                                    <label class="form-check-label payfor_friend" style="color: #fff !important;"
                                                        for="exampleCheck1">Crypto Currency Payment
                                                        <!-- <span
                                                    class="pl-3"><img src="{{ url('/') }}/public/customer/images/bit-pay-logo.png?q=<?php //echo rand();?>" style="width:100px;"></span> -->
                                                    </label>
                                                </div>
...
<script>
        ...
        html2 +=
            ...
            $('body').on('click', 'ul.package_list li', function () {
                ...
                if (package_id == "") {
                    ...
                    $("#disp_package_desc").html(package_name+' ('+package_desc+')');
    ...
    $("#pay_now").click(function () {
        var package_desc = $("#disp_package_desc").html();
        var amount = $(".disp_package_amt ").html();
        var payment_type = $("input[name='pay']:checked").val();
        if(payment_type == 'BANKPAYMENT') {
            var whatsapp_txt = 'https://api.whatsapp.com/send?phone=2347081808391&text=Hello, I would like to subscribe/renewal to your '+package_desc +' and '+amount+', please send me banking instructions. Thank you&source=&data=&app_absent=';
            var email_txt = 'mailto:help@bestbox.net?subject=Package in Bestbox&body=Hello, I would like to subscribe/renewal to your '+package_desc +' and '+amount+', please send me banking instructions. Thank you';
            $(".whatsapp_txt").attr('href',whatsapp_txt);
            $(".mail_txt").attr('href',email_txt);
            $("#bankpaymentAlertModal").modal("show");
        }else if(payment_type == 'Crypto Currency'){
            var whatsapp_txt = 'https://api.whatsapp.com/send?phone=00971527925634&text=Hello, I would like to subscribe/renewal to your '+package_desc +' and '+amount+' using Crypto, please send me the instructions. Thank you&source=&data=&app_absent=';
            var email_txt = 'mailto:help@bestbox.net?subject=Package in Bestbox&body=Hello, I would like to subscribe/renewal to your '+ package_desc +' and '+amount+' using Crypto, please send me the instructions. Thank you';
            $(".whatsapp_txt").attr('href',whatsapp_txt);
            $(".mail_txt").attr('href',email_txt);
    ...
    $(".payment").click(function () {
        if ($(this).is(":checked")) {
            ...
            if (payment_type == 'everuspay') {
                ...
                $("#bitpay_pay").addClass("d-none");
                $("#bankpay_pay").addClass("d-none");
            } else if (payment_type == 'bitpay') {
                $("#bitpay_pay").removeClass("d-none");
                $("#everuspay_pay").addClass("d-none");
                $("#wallet_pay").addClass("d-none");
                $("#bankpay_pay").addClass("d-none");
            }else if (payment_type == 'bankpayment') {
                $("#bitpay_pay").addClass("d-none");
                $("#everuspay_pay").addClass("d-none");
                $("#wallet_pay").addClass("d-none");

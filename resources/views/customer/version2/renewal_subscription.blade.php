        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <section class="main_body_section scroll_div col-12">
                    ...
                    <h5 class="f20 font-bold text-uppercase text-white py-3">Renewal</h5>
                                ...
                                <div class="col-12 subcribe_wrp mb-3" id="subscribe_options">
                                    ...
                                    <div class="form_bg6">
                                        <label for="exampleInputEmail1" class="font-bold black_txt">Payment Method</label>
                                            ...
                                            <div id="bitpay_pay" class="col-12 mt-4 pl-0">
                                                <div class="form-group form-check">
                                                    <input type="checkbox" name="pay" id="pay" data-value='bitpay' value="Crypto Currency" class="payment form-check-input" style=" width: inherit;">
                                                    <label class="form-check-label payfor_friend" for="exampleCheck1">Crypto Currency Payment
                                                    <!--<span class="pl-3"><img src="{{ url('/') }}/public/customer/images/bit-pay-logo.png?q=<?php //echo rand();?>" style="width:70px;"></span>-->
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-12 mt-4 pl-0 {{ $userInfo['admin_login'] == 1 ? '' : 'd-none'}}">
                                                <div class="form-group form-check">
                                                    <input type="checkbox" name="pay" id="pay" data-value='aliexpress' class="payment form-check-input" style=" width: inherit;" value="ALIEXPRESS">
                                                    <label class="form-check-label payfor_friend" for="exampleCheck1">VISA / MASTERCARD<span class="pl-3"><img src="{{ url('/') }}/public/customer/images/cards.png?q=<?php echo rand();?>"
                                                            style="width:85px;"></span></label>
                                                </div>
                                            </div>
                                            <div class="col-12 mt-4 pl-0 {{ $userInfo['admin_login'] == 1 ? '' : 'd-none'}}">
                                                <div class="form-group form-check">
                                                    <input type="checkbox" name="pay" id="pay" data-value='bankpayment' class="payment form-check-input" style=" width: inherit;" value="BANKPAYMENT">
                                                    <label class="form-check-label payfor_friend" for="exampleCheck1">Nigeria or Ghana based bank payments</label>
                                                </div>
                                            </div>
        ...
        $(".payment").click(function(){
            ...
            if ($(this).is(":checked")) {
                ...
                if(payment_type == 'everuspay') {
                    ...
                    $("#bitpay_pay").addClass("d-none");
                    $("#aliexpress_payment_div").css('display','none');
                }else if(payment_type == 'aliexpress'){

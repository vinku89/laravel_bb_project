...
<body>
   ...
   @include("inc.sidebar.sidebar")
    <div class="main-content">
        ...
        <section class="main_body_section scroll_div" id="main_section">
           
            <h5 class="font22 font-bold black_txt py-4">Buy/Subscribe</h5>
        ...
        <div id="checkOut_div">
            <div class="col-12 mb-4 pl-0">
                <div class="row">
                        ...
                        <div class="iptv_box_wrp white_bg iptv_box box-100">
                            <div class="box_header">
                                ...
                                @if($sel_package_det->duration !=0 && $sel_package_det->duration != '')
                                    <p class="m-0 pt-2 font-bold">{{ $sel_package_det->duration }} MONTH{{ $sel_package_det->duration >1 ? 'S' : ''}} SUBSCRIPTION</p>
                                @endIf
                            </div>
                            <div class="box-middle mb-0">
                                <img src="{{ url('/') }}/public/customer/images/iptv-box.png?q=<?php echo rand(); ?>"
                                    class="img-fluid">
                                @if($sel_package_det->duration !=0 && $sel_package_det->duration != '')
                                <p>{{ $sel_package_det->duration }} MONTH{{ $sel_package_det->duration >1 ? 'S' : ''}} SUBSCRIPTION<br><br></p>
                                @endIf
                    ...
                    <div class="col-xl-6 col-lg-8 col-md-7 clearfix">
                        <ul class="ul_text clearfix">
                            <li>Package</li>
                            <li>: {{ $sel_package_det->package_name }}</li>
                            @if($sel_package_det->duration !=0 && $sel_package_det->duration != '')
                            <li>Duration</li>
                            <li>: {{ $sel_package_det->duration }} MONTH{{ $sel_package_det->duration >1 ? 'S' : ''}} SUBSCRIPTION</li>
                            @endIf                            
            ...
            <input type="hidden" name="initial_package_name" id="initial_package_name" value="{{ $sel_package_det->package_name }}">
            <input type="hidden" name="initial_package_amount" id="initial_package_amount" value="{{ $sel_package_det->effective_amount }}">
            <input type="hidden" name="initial_package_desc" id="initial_package_desc" value="{{ $sel_package_det->description }}">
            <input type="hidden" name="initial_package_setupbox" id="initial_package_setupbox" value="{{ $sel_package_det->setupbox_status }}">
            <input type="hidden" name="initial_package_value" id="initial_package_value" value="{{ $sel_package_det->package_value }}">
            <input type="hidden" name="initial_package_discount" id="initial_package_discount" value="{{ $sel_package_det->discount }}">
            <div class="col-12 mb-4 pl-0">
                <h5 class="font16 font-bold black_txt pt-4 mb-3">Payment Method</h5>
                <div class="select_payment col-xl-5 col-lg-6 col-md-7">
                    <div class="form-check mb-4">
                        <input class="form-check-input" type="radio" name="pay" id="exampleRadios1" value="WALLET">
                        <label class="form-check-label" for="exampleRadios1">
                            Pay From My BestBOX Wallet
                        </label>
                    </div>
                    <div class="form-check mb-4">
                        <input class="form-check-input" type="radio" name="pay" id="exampleRadios2" value="ALIEXPRESS">
       ...
       <div class="col-12 pl-0">
            <h5 class="font18 font-bold black_txt purple_txt">Payment Method</h5>
       </div>
        <div class="col-xl-5 col-md-8 pl-0" >
            <div id="wallet_div" class="d-none">
                <h5 class="font16 font-bold black_txt pt-3 mb-3">Pay From My BestBOX Wallet</h5>
            ...
            <h5 class="font16 font-bold black_txt mt-4 mb-3">BestBOX Package</h5>
            <div class="col-12 px-0 mb-4">
                <div class="select-test">
                    <input type="hidden" name="package" id="package" value="{{ $sel_package_det->id }}">
                    <input type="hidden" name="package_amount" id="package_amount" value="{{ $sel_package_det->effective_amount }}">
                    <input type="hidden" name="package_name" id="package_name" value="{{ $sel_package_det->package_name }}">
                    <input type="hidden" name="package_desc" id="package_desc" value="{{ $sel_package_det->description }}">
                    <input type="hidden" name="setupbox_status" id="setupbox_status" value="{{ $sel_package_det->setupbox_status }}">
                    <input type="hidden" name="package_discount" id="package_discount" value="{{ $sel_package_det->discount }}">
                    <input type="hidden" name="package_value" id="package_value" value="{{ $sel_package_det->package_value }}">
                    <input type="hidden" name="payment_method" id="payment_method" value="">
                     <button class="select_package_drop" style="border:1px solid #A02C72; border-radius:5px;">
                        <span>
                            <div class="p-1" style="width: 100%;background-color:#fff;"><div class="float-left" style="width:75%"><div style="font-weight: 700;">{{ $sel_package_det->package_name }}</div><div>{{ $sel_package_det->description }}</div></div><div class="float-right font-bold pr-2 pt-3">${{ $sel_package_det->effective_amount }}</div></div>
                        </span>
                        <span class="caret"></span>
                    </button>
                    <ul class="f16 package_list">
                        @foreach ($package_data as $val) 
                                <li value="{{ $val->id }}" data-name="{{ $val->package_name }}" data-duration="{{ $val->duration }}" data-desc="{{ $val->description }}" data-package="{{ $val->id }}" data-amt="{{ $val->effective_amount }}" data-setupbox="{{ $val->setupbox_status }}" data-value="{{ $val->package_value }}" data-discount="{{ $val->discount }}" <?php if($val->id == $sel_package_det->id) echo 'selected';?> class="text-left border-top-purple" style="display: table; width: 100%;">
            ...
            <div class="d-none" id="delevery_addr">
                <h5 class="font16 font-bold black_txt mt-4 mb-3">Delivery Address</h5>
                ...
                <div class="purple-bordered p-4" id="select_address">
                    <div class="address_wrp_scroll ">
                        <div class="bottom-purple-bordered pb-2 mb-4 userSelect_address">
                            <h5 class="font16 font-bold black_txt mb-3">Default Address</h5>
                            <?php
                                if(!empty($default_address)){
                                    echo "<h5 class='font16 font-bold black_txt'>".$default_address->name."</h5>";
                            ...
                            ?>
                            <input type="hidden" name="default_addr" id="default_addr" value="<?php echo (!empty($default_address)? 1 : 0)?>">
                        </div>

                        <div class=" pb-2 mb-4 userSelect_address">
                            <h5 class="font16 font-bold black_txt mb-3 select_addr_hd {{ count($all_address) > 0 ? '' : 'd-none' }}">Select Address</h5>
                            <?php
                                ...
                                foreach ($all_address as $key => $value) {
                                    ...
                                    <div class="bottom-purple-bordered position-relative pb-4 pl-3 mb-3">
                                        <input class="form-check-input ml-1 shiping_address_radio" type="radio" name="sel_shipping_address" value="<?php echo $value->rec_id;?>">
                                        <?php
                                            echo "<p>".$value->name."</p>";
                                        ...
                                        <div class="form-check mt-4">
                                            <input class="form-check-input set_default_addr" type="checkbox" name="set_default_addr" id="set_default_addr" value="<?php echo $value->rec_id;?>" >
            ...
            <div class="purple-bordered p-4" id="newAddress_div" style="display:none">
                <h5 class="font16 font-bold black_txt mb-3">New Address</h5>
                <form method="post" id="addnewAddressForm">
                <div class="form-group">
                    <input type="name" class="form-control border-bottom-only" value="{{ $userInfo->first_name.' '.$userInfo->last_name }}" id="sh_name" name="sh_name" aria-describedby="name" placeholder="Name">
                    <div class="text-right f14 w-100 pt-2">
                        <span class="text-danger">*</span>
                        <span id="emailHelp" class="text-muted f14 black_txt">Set Name</span>
                    ...
                    <select id="shipping_country" name="shipping_country">
                        ...
                        <?php
                            foreach ($country_data as $val) {
                                ?>
                                <option value='<?php echo $val->countryid;?>' data-id='<?php echo $val->currencycode;?>'><?php echo $val->country_name;?></option>
                         <?php   }
                        ?>
                    </select>
                    <div class="text-right f14 w-100 pt-2">
                        <span class="text-danger">*</span>
                        <span id="emailHelp" class="text-muted f14 black_txt">Country</span>
                    </div>                    
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        <input type="text" class="form-control border-bottom-only with_addon_icon body_bg"
                                        ...
                                        aria-describedby="basic-addon2" name="shipping_country_code" id="shipping_country_code" readonly>
                    </div>
                    <div class="col-sm-9">
                        <input type="name" class="form-control border-bottom-only" id="shipping_mobile_no" name="shipping_mobile_no" aria-describedby="name" placeholder="Mobile Number">
                        <div class="text-right f14 w-100 pt-2">
                            <span class="text-danger">*</span>
                            <span id="emailHelp" class="text-muted f14 black_txt">Set Phone Number</span>
                        </div>
                ...
                <div class="mt-4 mb-5">
                <div class="row">
                    <div class="col-6"> <a href="#" id="cancel_newaddress" class="backBtn col-xl-12">Cancel</a></div>
                    <div class="col-6"> <a href="#" id="add_newaddress" class="check_out_btn col-xl-12">Create</a></div>
                </div>
            </div>
        </form>
            </div>
            ...
            <div class="mt-4 mb-5">
                <div class="row">
                    <div class="col-6"> <a href="#" id="back_pm" class="backBtn col-xl-12">Back</a></div>
                    <div class="col-6"> <a href="#" id="place_order" class="check_out_btn col-xl-12">Place Order</a></div>
                </div>
            </div>
        </div>
    </form>
         ...
         <section class="main_body_section scroll_div" id="confirm_section">
           
            <h5 class="font22 font-bold black_txt py-4">Confirmation</h5>
            <div class="mb-5">
            ...
            <div class="col-xl-5 col-md-8 pl-0">
                ...
                <div class="d-none" id="step3_delivery_addr">
                    <h5 class="font16 font-bold black_txt pt-4 mb-3">Delivery Address:-</h5>
                        <div id="delivery_addr">
                        <?php
                                if(!empty($default_address)){
                                    echo "<h5 class='font16 font-bold black_txt'>".$default_address->name."</h5>";
                                    echo $default_address->shipping_address;
            ...
            <div class="mt-4 col-md-8 pl-0 mb-5">
                <div class="row">
                    ...
                    <div class="col-6"> <a href="#" id="pay_now" class="check_out_btn col-xl-12">Pay Now</a></div>
                </div>
            </div>
    ...
    $('.menucheck').on('change', function() {
            ...
            {  
                ...
                if(payment_method == 'WALLET'){
                    if(parseFloat(amount) > parseFloat(user_wallet_amt)){
                            ...
                            setTimeout(function() {
                                $(".select-test span:first").html('<div class="p-1" style="width: 100%;background-color:#fff;"><div class="float-left" style="width:75%"><div style="font-weight: 700;">'+initial_package_name+'</div><div>'+initial_package_desc+'</div></div><div class="float-right font-bold pr-2 pt-3">$'+initial_package_amount+'</div></div>');
        ...
        $(document).ready(function() {
            $("#check_out").click(function () {
                ...
                if(!$("input[name='pay']:checked").val()){
                    ...
                    var url = "https://www.aliexpress.com/item/<?php echo $sel_package_det->aliexpress_url; ?>";
            ...
            $("#shipping_mobile_no").on("keypress keyup blur",function (event) {    
             ...
             $("#add_newaddress").click(function(e){
                ...
                if (mobile == '') {
                    ...
                    $.ajax({
                        ...
                        data: {'set_default':set_default,'name':sh_name,'shipping_address':shipping_address,'shipping_country':country,'shipping_country_code':country_code,'shipping_mobile_no':mobile,'_token':token},//$('#addnewAddressForm').serialize(),
                        dataType: "json",
             ...
             $("#place_order").click(function(e){
                ...
                if(setupbox_status == 1){
                    if ($("input:radio[name=sel_shipping_address]:checked").length == 0 && default_addr == 0) {
                        swal(
							'Failure',
        ...
        $('body').on('click', '.shiping_address_radio', function(){
            ...
            $.ajax({
                ...
                data: {'ship_id':ship_id,'_token':token},//$('#addnewAddressForm').serialize(),
                dataType: "json",
                success: function (data) {
                    console.log(data);
                    if(data.status == "Success"){
        ...
        $('body').on('change', '.set_default_addr', function() {
            ...
            if(vl){
                ...
                $.ajax({
                    ...
                    data: {'ship_id':ship_id,'check_status':check_status,'_token':token},//$('#addnewAddressForm').serialize(),
                    dataType: "json",
                    success: function (data) {
                        console.log(data);
                        if(data.status == "Success"){

<?php 
    $redirectURL = (isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER']!='') ? $_SERVER['HTTP_REFERER'] : 'livetv';
?>
<!doctype html>
...
<head>
    ...
    <title>BestBOX - Live tv Details</title>
    <!-- Styles -->
    ...
    <link href="<?php echo url('/');?>/public/css/customer/carousel.css" rel="stylesheet?q=<?php echo rand();?>">
                    ...
                    <div class="section_div col-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="input-group my-2">
                                    <input type="text"
                                        class="form-control bg-transparent no-border-right text-white border-rounded-left" id="searchKey" value="<?php echo (isset($searchKey)) ? $searchKey : ""; ?>"
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text bg-transparent no-border-left border-rounded-right search_btn"
                                            id="basic-addon2"><img src="<?php echo url('/');?>/public/img/customer/search.png" class="img-fluid"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-lg-3 align-self-center my-2">

                                <select class="form-control country_filter" id="select2-single-box" name="select2-single-box"
                            ...
                            <div class="col-md-4 col-lg-3 align-self-center my-2">
                                <select class="form-control category_filter" id="select2-single-box1" name="select2-single-box"
                        ...
                        <div class="position-relative">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="row-title d-inline-block pr-4">
                                        <?php echo (!empty($searchKey)) ? 'Search Key :'.$searchKey : $livetv['title'];?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <?php
                            if(!empty($livetv['data']) && @count($livetv['data'])){ $i=0;?>
                            <div class=" my-4">
                                <ul class="m-auto p-0 row detail-wra">
                                    ...
                                    ?>
                                    <li class="text-center col-6 col-md-4 col-lg-3 col-xl-2 mb-3">
                                        <a class="carousel-tile img-fluid" href="<?php echo url('/');?>/livetvChannelView/<?php echo $slug;?>">
              ...
              <div class="modal-footer border-top-0 p-0 mt-4">
                ...
                <div class="row">
                    <div class="col-6 pr-0">
                        <a href="<?php echo url('/').'/livetv?page=1&country_id='.$country_id.'&category='.$category;?>" class="modalFooter_btn modalFooter_btn_cancel" >Cancel</a>
                    </div>
...
<!--adult modal popup ends-->
    <script type="text/javascript">
        ...
        $(".search_btn").click(function(e){
            ...
            var searchUrl = url2+'?page=1&country_id='+country_id+'&category='+category+'&search='+searchKey;

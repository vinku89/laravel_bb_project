...
if(!empty($vod_info)){
    ...
    if(Session::has('vod_redirectURL') && Session::get('vod_redirectURL') != ''){
        $redirectURL = Session::get('vod_redirectURL');
    }else{
        $redirectURL = url('/').'/vod';
    }
}
...
<head>
    ...
    <style>
        ...
        .play-js.play-fullscreen .play-fullscreen-control .play-icon-placeholder:before{
            background-image : url('../images/player/player-zoom-in.svg');
        }
    </style>

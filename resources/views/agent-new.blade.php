        ...
        <section class="main_body_section scroll_div">
            <nav aria-label="breadcrumb">
                ...
                <i class="fas fa-angle-left"></i>
                    ...
                    <li class="breadcrumb-item active f16" aria-current="page" class="f16">Add New Agent</li>
                </ol>
            </nav>

            <h5 class="font16 font-bold text-uppercase black_txt pt-4 mb-5">Add New Agent</h5>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="clearfix row">
                <div class="col-12">
                    <div class="form-width">
                        <form method="post" id="create_form" name="create_form" action="<?php echo url('/').'/createAgent';?>" class="needs-validation" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-right f14"><span class="text-danger">*</span><span id="email" class="text-muted f14 black_txt">Agent Email</span></div>
                        ...
                        <div class="form-group row">
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control border-bottom-only body_bg" placeholder="Code" aria-label="Mobile number"
                                        aria-describedby="basic-addon2" value="{{ old('country_code') }}" name="country_code" id="country_code" readOnly>
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="input-group mb-3">
                                    <input type="text" class="border-bottom-only  body_bg" placeholder="Mobile Number" aria-label="Mobile number"
                                        aria-describedby="basic-addon2" id="mobile" name="mobile" value="{{ old('mobile') }}" pattern="[0-9]{8,14}">
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3 text-green">
                                <input type="number" class="form-control border-bottom-only with_addon_icon text-green body_bg"
                                    ...
                                    aria-describedby="basic-addon2" value="{{ old('commission_perc') }}" max="<?php echo $userInfo->commission_perc;?>" min="0" required>
                                <span class="input-group-text no-border no-bg text-success addon_icon">%</span>
                               <div class="text-right f14 w-100 pt-2"><span class="text-danger">*</span><span id="emailHelp" class="text-muted f14 black_txt">Agent Commission Percentage</span></div>
                                <div class="invalid-feedback">

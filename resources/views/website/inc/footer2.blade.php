    ...
    <div class="container">
        ...
        <div class="col-md-9">
          ...
          <div class="footer-links">
            <ul class="row font-bold">
              <li class="col-md-3"><a href="<?php echo url('/');?>/#streaming" >Unlimited Streaming</a></li>
              <!--<li class="col-md-3"><a href="<?php echo url('/');?>/#subscribenow" >Subscribe Now</a></li>-->
              <li class="col-md-3"><a href="<?php echo url('/');?>/#refer" >Refer Your Friends</a></li>
              <li class="col-md-3"><a href="<?php echo url('/');?>/#faq" >FAQ</a></li>
      ...
      <div class="row py-4">
        <div class="col-lg-12 text-white text-center">
          <p class="font-bold m-auto">Copyright &copy; Bestbox. All trademarks and copyrights belong to their respective owners.</p>

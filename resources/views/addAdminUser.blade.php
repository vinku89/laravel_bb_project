        ...
        <section class="main_body_section scroll_div">
            <nav aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item f16"><a href="{{ url('/').'/resellers' }}" class="f16">Admin User</a></li>
                    <li class="breadcrumb-item active f16" aria-current="page" class="f16">Add New Admin User</li>
                </ol>
            </nav>

            <h5 class="font16 font-bold text-uppercase black_txt pt-4 mb-5">Add New Admin User</h5>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="clearfix row">
                <div class="col-12">
                    <div class="form-width">
                        ...
                        <form method="post" id="create_form" name="create_form" action="<?php echo url('/').'/createAdminUser';?>" class="needs-validation" novalidate>
                        ...
                        <!-- First Name -->
                        <div class="form-group">
                            <input type="text" class="form-control border-bottom-only body_bg" id="first_name"  name="first_name" aria-describedby="first_name" placeholder="First Name" value="{{ old('first_name') }}" minlength="3" maxlength="255" required>
                        ...
                        <!-- Last Name -->
                        <div class="form-group">
                            <input type="text" class="form-control border-bottom-only body_bg"  id="last_name"  name="last_name" aria-describedby="last_name" placeholder="Last Name" value="{{ old('last_name') }}" minlength="3" maxlength="255" required>
                        ...
                        <!-- Address Line 1 -->
                        <div class="form-group">
                            <input type="name" class="form-control border-bottom-only body_bg" id="address" name="address" aria-describedby="emailHelp" placeholder="Address Line 1" value="{{ old('address') }}">
                        ...
                        <!-- Address Line 2 -->
                        <div class="form-group">
                            <input type="address" class="form-control border-bottom-only body_bg" id="address2" name="address2" aria-describedby="emailHelp" placeholder="Address Line 2" value="{{ old('address2') }}">
                        ...
                        <!-- Pin code -->
                        <div class="form-group">
                            <input type="text" class="form-control border-bottom-only body_bg" id="zipcode" name="zipcode" aria-describedby="zipcode" placeholder="ZIP/Postal" value="{{ old('zipcode') }}">
                            ...
                            <div class="col-9">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control border-bottom-only  body_bg" placeholder="Mobile Number" aria-label="Mobile number"
                                        aria-describedby="basic-addon2" id="mobile" name="mobile" value="{{ old('mobile') }}" pattern="[0-9]{8,14}" required>
                            ...
                            <select id="select_role" name="role" required>
                                ...
                                <?php
                                    foreach ($user_roles as $r) {
                                        echo "<option value='".$r['id']."' data-id='".$r['role_name']."'>".$r['role_name']."</option>";
                                    }
                                ?>
                            </select>

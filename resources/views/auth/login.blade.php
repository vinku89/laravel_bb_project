...
<body class="template_bg">
    <div class="box innerBox">
                <div class="login_box ">
                    ...
                    <h4 class="font16 text-uppercase text-center mb-5 black_txt"><span class="font-weight-bold">welcome,</span> please sign in</h4>

                    <div class="col-12 mb-2">
                            <form class="needs-validation" novalidate method="post" id="loginForm" action="<?php echo url('/');?>/login">
                            ...
                            <div class="login_footer_txt">
                                ...
                                <!-- <p class="text-center">This site is fully compatible with Chrome browser</p> -->
    ...
    function checkUserNameVal(){
        ...
        if(email){
            ...
            $.ajax({
                ...
                method: 'POST',
                dataType: "json",
                data: {'login_type':'Reseller','email':email,'_token':token},

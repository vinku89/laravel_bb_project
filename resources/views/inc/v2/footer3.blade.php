<footer class="py-2 d-none" style="background-color: #303030;">
...
<?php 
                    ...
                    <div class="modal fade" id="announcementPopup" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content" style="border-radius: 10px !important;">
                                    ...
                                    <div class='modal-body noti-body px-md-5 px-3 pb-2 pb-md-5 pt-0 pt-md-4'>
    ...
    <script>
    $("#announcementPopup_flag_update").click(function (e) {
        e.preventDefault();
    ...
    if(!empty($user_logout)) {?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body text-center red_txt">
                    You have logged out due to logged in another device/browser.
            </div>
            <!-- Modal footer -->
            <!-- Modal footer -->

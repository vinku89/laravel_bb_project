...
<head>
    ...
    <title>BestBOX - Pay for friend</title>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pl-0 pb-0">
                    <li class="breadcrumb-item f16">
                        <a href="<?php echo url('/transactions');?>" class="f16 position-relative breadcrumb_pd">
                            <i class="fas fa-angle-left"></i>
                            Transactions
                         </a>
                </li>
                    <li class="breadcrumb-item active f16" aria-current="page" class="f16">Pay For My Friend</li>
                </ol>
            </nav>

            <h5 class="font20 font-bold text-uppercase black_txt pt-4 mb-3">PAY FOR MY FRIEND</h5>

            <div class="clearfix col-12">
                <div class="row">
                    <div class="form-width2">
                      <div id="step1">
                        <form method="post" id="create_form" name="create_form" action="<?php echo url('/').'/savePayForMyFriend';?>" class="needs-validation" novalidate>
                                   ...
                                   <label for="exampleInputEmail1" class="font-bold black_txt">Payment Method</label>
                                       <div class="col-12 mt-3 pl-0">
                                           <div class="form-group form-check">
                                               <input type="checkbox" name="pay" id="exampleCheck1" data-value='wallet' value="WALLET" class="payment form-check-input" style="width: inherit;">
                                       ...
                                       <!--<div class="col-12 mt-4 pl-0" >
                                            <div class="form-group form-check">
                                                <input type="checkbox" name="pay" id="exampleCheck2" data-value='bitpay' value="BITPAY" class="payment form-check-input" style=" width: inherit;">
                                                <label class="form-check-label payfor_friend" for="exampleCheck2" >Crypto Currency Payment
                            ...
                            <p class="font-weight-bold black_txt font-bold text-uppercase">Payment Method</p>
                                ...
                                <div class="form_bg6 mb-5">
                                    ...
                                    <div class="d-none" id="everuspay_pay">
                                        <div class="col-12 mt-4 pl-0">
                                            <div class="form-group form-check">
                                                <label class="form-check-label payfor_friend" for="exampleCheck1">CRYPTO PAYMENT
                                                    <!--<span
                                    ...
                                    <!--<div class="d-none" id="bitpay_pay">
                                        <div class="col-12 mt-4 pl-0">
                                            <div class="form-group form-check">
                                                <label class="form-check-label payfor_friend" for="exampleCheck1">Crypto Currency Payment<!--<span

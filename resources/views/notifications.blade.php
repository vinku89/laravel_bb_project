...
<body>
    ...
    <div class="main-content commission_report_details">
        ...
        <section class="main_body_section scroll_div">
            <h5 class="font16 black_txt font-bold text-uppercase pt-4 pb-3">Notifications</h5>
            ...
            <div class="grid_wrp">
                    <div class="grid_header clearfix pt-3 pb-3 res_mobileView">
                        ...
                        <div class="w60 float-left font16 font-bold blue_txt pl-2 d-none d-lg-block">Action & Descriptions</div>
                        <div class="w15 float-left font16 font-bold blue_txt d-none d-lg-block">Status</div>
                            ...
                            <div class="card res_mobileView">
                                <div class="mb-0">
                                        <a class="collapsed grid_row clearfix"  data-toggle="collapse" href="#collapse-{{ $key }}" aria-expanded="false" aria-controls="collapse-{{ $key }}">
                                            ...
                                            <div class="w60 float-left font16 dark-grey_txt pl-2 d-none d-lg-block"><?php echo (empty($payment_history)) ? $item['ttype'] : 'EverusPay';?></div>
